...
public class JavaClassImpl extends AbstractHasAnnotations implements JavaClass {
    ...
    public JavaClassImpl(String packageName, String name, int modifiers, JavaType enclosingType) {
        this.setName(name);
    ...
    public JavaClassImpl(String packageName, String name, int modifiers) {
        this(packageName, name, modifiers, null);
    }

    public JavaClassImpl(String packageName, String name, JavaType enclosingType) {
